...
class MobileNetV3_Small(BaseModel):
    def __init__(self, num_classes=1000):
        ...
        self.conv2 = nn.Conv2d(48, 96, kernel_size=1, stride=1, padding=0, bias=False)
...
class MNV3_large2_GD(BaseModel):
    def __init__(self, num_classes):
        super(MNV3_large2_GD, self).__init__()
        ...
        self.classifier = nn.Conv2d(in_channels=48, out_channels=num_classes, kernel_size=1,
